...
const trendingMoviesURL =
  "https://api.themoviedb.org/3/trending/movie/day?language=en-US&page=1&sort_by=popularity.desc";
const trendingTVShowsURL =
  "https://api.themoviedb.org/3/trending/tv/day?language=en-US&page=1&sort_by=popularity.desc";
...
const tmdb = {
  ...
  discoverMedia: (filters) => {
    ...
    if (filters.people) {
      URL += `&with_people=${filters.people}`;
    }
    console.log(URL);
    return fetchData(URL);
  },
